...
describe Ability do
  before :each do
    ...
    @event1 = Event.new(date: DateTime.now, description: "A test event ", location: "9 Back Hill, London, N1", name: "Event")
    ...
    @event2 = Event.new(date: DateTime.now, description: "A test event ", location: "9 Back Hill, London, N1", name: "Event")
